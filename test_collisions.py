...
class TestSphereRectanguloidCollisions:
    def test_no_collision(self):
        sphere = collisions.Sphere(jnp.array([0, 0, 0], dtype=jnp.float32), 1.0, 1.0)
    ...
    def test_no_collision(self):
        sphere = collisions.Sphere(jnp.array([0, 1.0, 0], dtype=jnp.float32), 0.49, 1.0)
        rectanguloid = collisions.Rectanguloid(
    ...
    def test_collision_just_touching(self):
        sphere = collisions.Sphere(jnp.array([0, 1.0, 0], dtype=jnp.float32), 0.5, 1.0)
        rectanguloid = collisions.Rectanguloid(
            jnp.array([-0.5, -0.5, -0.5], dtype=jnp.float32),
            jnp.array([0.5, 0.5, 0.5], dtype=jnp.float32),
        )
    ...
    def test_collision_a(self):
        sphere = collisions.Sphere(jnp.array([0, 1.0, 0], dtype=jnp.float32), 0.51, 1.0)
        rectanguloid = collisions.Rectanguloid(
            jnp.array([-0.5, -0.5, -0.5], dtype=jnp.float32),
            jnp.array([0.5, 0.5, 0.5], dtype=jnp.float32),
        )
    ...
    def test_corner_collision_rectanguloid_off_center(self):
        sphere = collisions.Sphere(
            jnp.array([10.55, 15.3, 21.05], dtype=jnp.float32), jnp.float32(0.1), 1.0
        )
        rectanguloid = collisions.Rectanguloid(
    ...
    def test_collision_sphere_inside_rectanguloid(self):
        sphere = collisions.Sphere(
            jnp.array([0, 0.5, 0], dtype=jnp.float32), jnp.float32(0.1), 1.0
        )
        rectanguloid = collisions.Rectanguloid(
            jnp.array([-0.5, -0.5, -0.5], dtype=jnp.float32),
            jnp.array([0.5, 0.5, 0.5], dtype=jnp.float32),
    ...
    def test_collision_sphere_flat_rectanguloid(self):
        sphere = collisions.Sphere(
            jnp.array([10.55, 15.1, 21.05], dtype=jnp.float32), jnp.float32(0.15), 1.0
        )
        rectanguloid = collisions.Rectanguloid(
            jnp.array([10.0, 15.0, 20.0], dtype=jnp.float32),
            jnp.array([10.5, 15.0, 21.0], dtype=jnp.float32),
        )
        intersections = jax.jit(collisions.collide_sphere_rectanguloid)(
            sphere, rectanguloid
        )
